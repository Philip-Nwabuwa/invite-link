    ...
    <div className="min-h-screen bg-[#7c3bed] text-white">
      <div className="max-w-7xl mx-auto w-full flex flex-col items-center px-4 py-8">
        ...
        <div className="text-center mb-5">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-[#fff] via-[#ff8f2e] to-[#ff8f2e] text-transparent bg-clip-text">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 justify-center items-center gap-8">
          <div className="space-y-6">
            <div className="bg-white/20 backdrop-blur-sm rounded-xl h-[250px] p-4 flex items-center justify-center border border-white/30">
              <Image
                src={RoboticHand}
                alt="Robotic Hand"
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="bg-[#7c3bed1a] size-10 rounded-full flex items-center justify-center">
                    <Calendar className="size-5 text-[#7c3bed]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <div className="bg-[#7c3bed1a] size-10 rounded-full flex items-center justify-center">
                    <MapPin className="size-5 text-[#7c3bed]" />
                  </div>
